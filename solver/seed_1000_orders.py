...
def generate_data():
    ...
    file_path = os.path.join(os.path.dirname(__file__), "1000_orders_hcm.json")
...
def seed_to_db(data):
    print("🔄 Đang đẩy 1000 đơn vào DB...")
    ...
    print("✅ Đã hoàn thành Seed dữ liệu 1000 đơn hàng vào CSDL!")
